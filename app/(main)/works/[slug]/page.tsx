            ...
            <main>
                ...
                <section className="relative h-screen w-full flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 lg:px-[120px] pb-[80px] relative z-10">
                        ...
                        >
                            <span className="font-poppins text-white/80 text-[14px] md:text-[18px] uppercase tracking-[0.2em] mb-4 block">
                                {project.category}
                            </span>
                            <h1 className="font-anton text-white text-[80px] md:text-[120px] lg:text-[180px] leading-[0.9] uppercase">
                                {project.name}
                            </h1>
                        </motion.div>
                    </div>
                    ...
                    <div className="container mx-auto max-w-[1440px]">
                        <div className="flex flex-col lg:flex-row gap-[60px] lg:gap-[120px]">
                            ...
                            <div className="lg:w-2/3">
                                ...
                                >
                                    <h2 className="font-anton text-[60px] md:text-[80px] uppercase mb-[30px] leading-tight">OVERVIEW</h2>
                                ...
                                <motion.div
                                    ...
                                    className="mt-[100px]"
                                >
                                    <h2 className="font-anton text-[60px] md:text-[80px] uppercase mb-[40px] leading-tight">WORK</h2>
